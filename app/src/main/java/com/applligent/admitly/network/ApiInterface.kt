...
interface ApiInterface {
    ...
    @JvmSuppressWildcards
    fun studentAddProject(@Body body: Map<String, Any>,
                          @Header(AUTHORIZATION) token: String): Call<Any>

    @POST(COUNSELLOR_ADD_SERVICE_API)
    @JvmSuppressWildcards
    fun counselorAddService(@Body body: Map<String, Any>,
                            @Header(AUTHORIZATION) token: String): Call<Any>
    ...
    @JvmSuppressWildcards
    fun studentALLProject(@Body body: Map<String, Any>,
                            @Header(AUTHORIZATION) token: String): Call<Any>

    @POST(STUDENT_PROPOSALS_ALL_API)
    @JvmSuppressWildcards
    fun studentProposalAll(@Body body: Map<String, Any>,
                          @Header(AUTHORIZATION) token: String): Call<Any>

    @POST(COUNSELLOR_HIRE_API)
    @JvmSuppressWildcards
    fun counsellorHire(@Body body: Map<String, Any>,
                          @Header(AUTHORIZATION) token: String): Call<Any>
    ...
    @JvmSuppressWildcards
    fun studentAddRating(@Body body: Map<String, Any>,
                        @Header(AUTHORIZATION) token: String): Call<Any>
}